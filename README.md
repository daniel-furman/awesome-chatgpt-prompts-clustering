...
**Figure 3**. A visualization of the dataset's core themes (see leftmost elements, "core theme") and exemplars (see rightmost elements, "exemplars"). The sub-clusters are arranged in descending order by count (most frequent to least). Themes were generated by `gpt-3.5-turbo-16k`.
