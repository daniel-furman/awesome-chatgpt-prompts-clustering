...
**Figure 1**. The most persistent prompts in each leaf cluster are "exemplars". These prompts represent the hearts around which the ultimate cluster forms.
...
**Figure 2**. Sub-clustering of exemplars to pinpoint the core themes across the dataset. The prompts in each sub-cluster are subsequently fed to `gpt-3.5-turbo-16k` for theming.

![](assets/experiment_02_09_2023_16_54_32/exemplars_viz_2.png)

### Core Themes

**Figure 3**. A visualization of the core themes and exemplar prompts across the dataset. As mentioned above, the themes were automatically generated by `gpt-3.5-turbo-16k`.
